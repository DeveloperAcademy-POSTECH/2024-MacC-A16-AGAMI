...
final class ArchivePlaylistViewModel: Hashable {
    ...
    var dummyPlaylist: [SongModel] = (0..<10).map { index in SongModel(songID: UUID().uuidString, title: "Dummy Song\(index)", artist: "Dummy Artist", albumCoverURL: "https://dummyimage.com/400x400/fff/000") }
