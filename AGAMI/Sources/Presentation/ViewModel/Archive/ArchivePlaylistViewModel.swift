...
final class ArchivePlaylistViewModel: Hashable {
    ...
    var dummyPlaylist: [FirestoreSongModel] = (0..<10).map { index in FirestoreSongModel(songID: UUID().uuidString, title: "Dummy Song\(index)", artist: "Dummy Artist", albumCoverURL: "https://dummyimage.com/400x400/fff/000") }
